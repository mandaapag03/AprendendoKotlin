...
fun main() {
    ...
    /* Operadores com Strings
        + -> Concatenar
     */
    val complemento: String = "Usando essa notação $"
    println("Hello " + "World") // Vai resultar em Hello World normalmente
    println("Outra forma de concatenação é ${complemento}")
